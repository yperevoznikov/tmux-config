...
# General {
	...
	export TMUX_POWERLINE_DIR_USER_THEMES="${XDG_CONFIG_HOME:-$HOME/.config}/tmux/tmux-powerline/themes"
	# Overlay directory to look for segments. There you can put your own segments outside the repo. Fallback will still be the "segments" directory in the repo.
	export TMUX_POWERLINE_DIR_USER_SEGMENTS="${XDG_CONFIG_HOME:-$HOME/.config}/tmux/tmux-powerline/segments"
...
# claude_code.sh {
	...
	# export TMUX_POWERLINE_SEG_CLAUDE_CODE_CREDENTIALS_FILE="$HOME/.claude/.credentials.json"
...
# weather.sh {
	...
	#   rm "/var/folders/x_/blj2dwf52hb4tht0503c2z3m0000gn/T//tmux-powerline/weather_cache_data.txt"
